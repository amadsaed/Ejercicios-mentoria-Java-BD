...
public class Cashier extends Thread{
    ...
    public Cashier(BlockingQueue<Order> orders, BlockingQueue<Client> clients, List<Stock> stocks, List<Sandwich> sandwiches) {
        this.orders = orders;
    ...
    private Sandwich selectSandwich(int id){
        int i = 0;
        Sandwich sandwich;
        while (this.sandwiches.get(i).getIdSandwich() != id && i < this.sandwiches.size()){
           i++;
        }
